...
* INLA is software that performs data wrangling for SPDE estimation
  ...
  * sdmTMB uses fmesher/INLA to wrangle matrices, but uses TMB for maximum likelihood estimation
]
...
But sdmTMB can also work with any fancier fmesher mesh.
...
# Interpolation from mesh to data
...
This is what sdmTMB does for you. 🤓
