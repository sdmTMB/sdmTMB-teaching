...
.small[
Key concept: EB estimates are pulled towards the observations and are not expected to reflect a draw from the random effect distribution (which is assumed MVN here).
]
